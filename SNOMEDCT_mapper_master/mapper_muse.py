...
from SNOMEDCT_mapper_master.read_snomed_muse import load_lexicon
from SNOMEDCT_mapper_master.helper_tools import ngrams, sanatize, get_tuple, flatten, group
...
STANDARD_LEXICON = "Muse_codes" # Sets the standard subset of the SNOMED database to use
#---------------------------------------------------------------------------------------------
...
class Mapper:
    ...
    def acronym_search(self):
        ...
        acronyms = load_lexicon("my_acronyms_muse")
        length = self.get_num_words()
